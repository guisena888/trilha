...
//Vertical Horizontal
    ...
    switch (X) {
        case 0: {
            switch (Y) {
                ...
                case 3: { //peça nº 2 verticalmente
                    yCenter = 300;
                    xCenter = 28;
                    break;
                }
    ...
    if (isMillGreen || isMillRed) {
        ...
        if (numberOfTurns % 2 != 0) {
            ...
            context.drawImage(img, xCenter-16, yCenter-16, 32, 32);
        ...
        if ((X >= 0 && X <= 573) && (Y >= 0 && Y <= 573)) {
            ...
            if (multiPLayer && !ehMinhaVezDeJogar()) {
                ...
                if ((X >= 0 && X <= 75) && (Y >= 0 && Y <= 75)) {
                    ...
                    makeMove(5, 3);
                } else if ((X >= 475 && X <= 573) && (Y >= 235 && Y <= 315)) {
                    makeMove(6, 3);
                }
                ...
                else if ((X >= 0 && X <= 75) && (Y >= 550 && Y <= 573)) {
                    makeMove(0, 6);
                } else if ((X >= 235 && X <= 315) && (Y >= 550 && Y <= 573)) {
                    makeMove(3, 6);
                } else if ((X >= 475 && X <= 573) && (Y >= 550 && Y <= 573)) {
                    makeMove(6, 6);
                }
            }
        }
...
function turnOffActive(x, y) {
    ...
    var img = document.getElementById("image");
    context.drawImage(img, x-16, x-16, 32, 32);
    context.lineWidth = 2;
    context.stroke();
    isActiveRed = false;
    isActiveGreen = false;
...
function trocarImagem(caminho) {
    ...
    /*IMAGEM DE FUNDO,WALLPAPER*/ 
        ...
        document.getElementById('body').style = "background-image: url('https://wallpapermemory.com/uploads/280/galaxy-wallpaper-full-hd-1920x1080-443642.jpg";
    }else if (id == 'back_cap'){
        if (qtdVitorias > 0) {
            document.getElementById('body').style = "background-image: url('https://wallpaperset.com/w/full/0/8/2/30116.jpg');";
        }
        else {
            alert("Você precisa ter ao menos 1 vitória!");
        }
